...
import type { CampaignUpdateDTO, CampaignVO, MarketingCampaignStatus } from '@/types/promotion'
...
const form = reactive<CampaignUpdateDTO>({ name: '', startTime: undefined, endTime: undefined, description: '', creator: '', status: 'DRAFT', segmentId: undefined, emailTemplateId: undefined, variables: undefined })
