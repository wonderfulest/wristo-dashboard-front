...
export function commitVariantKeyDraft(form: UnitForm, drafts: Record<string, string>, oldKey: string, newKey: string): string | null
...
export function isInterceptorHandledError(error: unknown): boolean
